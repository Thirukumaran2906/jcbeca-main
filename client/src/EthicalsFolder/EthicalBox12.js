  ...
  return (
    <div className={styles.boxStyle}>
      ...
      <li>
        ...
        <li className={styles.listStyle}>JCBECA is an open access international journal.</li>
      ...
      <p className={styles.footerStyle}>JKRMS PUBLICATIONS online journal © 2024 is licensed under Creative Commons Attribution 4.0 International</p>
    </div>
  );
}
