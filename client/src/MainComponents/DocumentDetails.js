    ...
    <div className="container mx-auto mt-8 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {documentData.map((document, index) => (
          <div
            key={index}
            className="border p-6 rounded-lg shadow-lg bg-white hover:shadow-xl transition-shadow duration-300 ease-in-out"
          >
            ...
            <div className="mt-2">
              ...
              <p className="text-sm mb-2 text-black"><strong>Pages : {document.Pages}</strong> </p>
              <a
